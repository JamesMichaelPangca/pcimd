<script>
    !(function(NioApp, $) {
        ...
        @foreach ($budgets_chart as $data)
            label_data.push('{{ $data->mb_year }}');
            amount_data.push({{ $data->mb_amount }});
        @endforeach
        ...
        var profileBalance = {
            ...
            datasets: [{
                ...
                data: [111, 80, 125, 75, 95, 75, 90, 111, 80, 125, 75, 95, 75, 90, 111, 80, 125, 75, 95,
                    75, 90, 111, 80, 125, 75, 95, 75, 90, 75, 90
                ]
            }]
        };
        ...
        var orderOverview = {
            labels: ["19 Dec", "20 Dec", "21 Dec", "22 Dec", "23 Dec", "24 Dec", "25 Dec", "26 Dec", "27 Dec",
                "28 Dec", "29 Dec", "30 Dec", "31 Dec", "01 Jan"
            ],
            dataUnit: 'PESO',
            datasets: [{
                label: "Buy Orders",
                color: "#8feac5",
                data: [1740, 2500, 1820, 1200, 1600, 2500, 1820, 1200, 1700, 1820, 1400, 1600, 1930,
                    2100
                ]
            }, {
                label: "Sell Orders",
                color: "#b695ff",
                data: [2420, 1820, 3000, 5000, 2450, 1820, 2700, 5000, 2400, 2600, 4000, 2380, 2120,
                    1700
                ]
            }]
        };
        ...
        var userActivity = {
            ...
            datasets: [{
                label: "Direct Join",
                color: "#b695ff",
                data: [110, 80, 125, 55, 95, 75, 90, 110, 80, 125, 55, 95, 75, 90, 110, 80, 125, 55, 95,
                    75, 90
                ]
            }, {
                label: "Referral Join",
                color: "#ccd4ff",
                data: [125, 55, 95, 75, 90, 110, 80, 125, 55, 95, 75, 90, 110, 80, 125, 55, 95, 75, 90,
                    75, 90
                ]
            }]
        };
        ...
        var coinOverview = {
            ...
            datasets: [{
                ...
                label: "Sell Orders",
                color: [NioApp.hexRGB('#f98c45', .2), NioApp.hexRGB('#b695ff', .4), NioApp.hexRGB(
                    '#8feac5', .4), NioApp.hexRGB('#6b79c8', .4), NioApp.hexRGB('#79f1dc', .4)],
        ...
        var salesRevenue = {
            ...
            datasets: [{
                label: "Sales Revenue",
                color: [NioApp.hexRGB("#854fff", .2), NioApp.hexRGB("#854fff", .2), NioApp.hexRGB(
                        "#854fff", .2), NioApp.hexRGB("#854fff", .2), NioApp.hexRGB("#854fff", .2),
                    NioApp.hexRGB("#854fff", .2), NioApp.hexRGB("#854fff", .2), NioApp.hexRGB(
                        "#854fff", .2), NioApp.hexRGB("#854fff", .2), NioApp.hexRGB("#854fff", .2),
                    NioApp.hexRGB("#854fff", .2), "#854fff"
                ],
        ...
        var totalSubscription = {
            ...
            datasets: [{
                label: "Active User",
                color: [NioApp.hexRGB("#aea1ff", .2), NioApp.hexRGB("#aea1ff", .2), NioApp.hexRGB(
                        "#aea1ff", .2), NioApp.hexRGB("#aea1ff", .2), NioApp.hexRGB("#aea1ff", .2),
                    "#aea1ff"
                ],
                            ...
                            callbacks: {
                                ...
                                label: function(tooltipItem, data) {
                                    return data['labels'][tooltipItem['index']] + ' ' + data
                                        .datasets[tooltipItem.datasetIndex]['data'][tooltipItem[
                                            'index']];
                                }
                            },
                            backgroundColor: '#1c2b46',
        ...
        var supportStatus = {
            ...
            datasets: [{
                ...
                label: "Open",
                color: [NioApp.hexRGB('#f98c45', .4), NioApp.hexRGB('#b695ff', .4), NioApp.hexRGB(
                    '#8feac5', .4), NioApp.hexRGB('#6b79c8', .4), NioApp.hexRGB('#79f1dc', .4)],
                data: [66, 74, 92, 32, 26]
            }, {
                label: "Pending",
                color: [NioApp.hexRGB('#f98c45', .2), NioApp.hexRGB('#b695ff', .2), NioApp.hexRGB(
                    '#8feac5', .2), NioApp.hexRGB('#6b79c8', .2), NioApp.hexRGB('#79f1dc', .2)],
                data: [66, 74, 92, 21, 9]
            }]
        };
