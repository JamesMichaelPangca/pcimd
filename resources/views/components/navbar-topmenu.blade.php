...
@endphp
<div class="nk-header nk-header-fixed is-light bg-primary text-dark">
                        ...
                        <a href="#" class="dropdown-toggle me-n1" data-bs-toggle="dropdown">
                            <div class="user-toggle">
                                ...
                                <div class="user-info d-none d-xl-block">
                                    <div class="user-status user-status-active text-light"
                                        style="text-transform: uppercase;">
                                        Manage Account
                                    </div>
                                    <div class="user-name dropdown-indicator text-white" style="text-transform: uppercase">
                                        {{ Auth::user()->name }}
                                    </div>
                                </div>
                            </div>
